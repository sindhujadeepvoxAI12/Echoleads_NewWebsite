...
import { MessageCircle, Smartphone, Globe, BarChart3, Shield, Zap, Users, CheckCircle, ArrowRight, Play, Pause } from 'lucide-react';
import Button from '../../components/Button';
import whatsAppVideo from '../../assets/WhatsApp Agent.mp4';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl shadow-2xl p-8">
                <div className="relative aspect-video bg-gradient-to-br from-[#25D366] to-[#128C7E] rounded-xl overflow-hidden mb-6">
                  <video
                    ref={setVideoRef}
