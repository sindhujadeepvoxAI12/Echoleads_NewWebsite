...
import { Headphones, Clock, Users, BarChart3, Shield, Zap, MessageSquare, CheckCircle, ArrowRight, Play } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl shadow-2xl p-8">
                <div className="aspect-video bg-gradient-to-br from-[#F2A339] to-[#2E3192] rounded-xl flex items-center justify-center mb-6">
